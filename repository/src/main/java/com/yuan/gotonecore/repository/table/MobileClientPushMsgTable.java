...
/**
 * A table description for database table <tt>GTC_MOBILE_CLIENT_PUSH_MSG</tt>.<br> 
 * 移动app推送的消息
 * 
 *
 ...
 * @author nowli
 */
@DBTable(name="gtc_mobile_client_push_msg",comments="移动app推送的消息")
public class MobileClientPushMsgTable {
