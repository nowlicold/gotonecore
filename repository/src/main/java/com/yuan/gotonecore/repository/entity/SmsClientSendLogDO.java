...
/**
 * A data object class directly models database table <tt>gtc_sms_client_send_log</tt>.<br>
 * 短信客户端发送日志
 * 
 *
...
@ApiModel(value="SmsClientSendLogDO对象", description="短信客户端发送日志")
@TableName("gtc_sms_client_send_log")
public class SmsClientSendLogDO implements Serializable  {
	...
	/**
	 * This property corresponds to db column <tt>sms_client_send_id</tt>.<br>
     * 短信客户端发送ID
     */
