...
@TableName("gtc_mail_out")
@ApiModel(value="MailOutDO对象", description="邮件发送表")
public class MailOutDO implements Serializable {
    ...
    public static final String GMT_RESEND = "gmt_resend";
