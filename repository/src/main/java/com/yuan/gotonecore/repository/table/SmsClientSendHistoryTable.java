...
/**
 * A table description for database table <tt>GTC_SMS_CLIENT_SEND_HISTORY</tt>.<br> 
 * 短信客户端发送历史
 * 
 *
 ...
 * @author nowli
 */
@DBTable(name="gtc_sms_client_send_history",comments="短信客户端发送历史")
public class SmsClientSendHistoryTable {
     ...
     */
	 @DBColumn(name="client_send_result",dataType="text",dataDefault="",dataLength=65535,dataPrecision=0,dataScale=0,nullable=true,comments="客户端发送结果")
