...
/**
 * A data object class directly models database table <tt>gtc_activity_mail_user_link</tt>.<br>
 * 活动、邮件用户ID关联
 * 
 *
...
@ApiModel(value="ActivityMailUserLinkDO对象", description="活动、邮件用户ID关联")
@TableName("gtc_activity_mail_user_link")
public class ActivityMailUserLinkDO implements Serializable  {
	...
	/**
	 * This property corresponds to db column <tt>activity_id</tt>.<br>
     * 
     */
	private long activityId;
	
	/**
	 * This property corresponds to db column <tt>mail_user_id</tt>.<br>
     * 
     */
