...
/**
 * A table description for database table <tt>GTC_SMS_CLIENT_LOG</tt>.<br> 
 * 短信客户端日志
 * 
 *
 ...
 * @author nowli
 */
@DBTable(name="gtc_sms_client_log",comments="短信客户端日志")
public class SmsClientLogTable {
     ...
     */
	 @DBColumn(name="client_id",dataType="decimal(15,0)",dataDefault="",dataLength=15,dataPrecision=15,dataScale=0,nullable=false,comments="短信客户端发送ID")
