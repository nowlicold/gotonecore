...
/**
 * A data object class directly models database table <tt>gtc_sms_client_send</tt>.<br>
 * 短信客户端发送
 * 
 *
...
@ApiModel(value="SmsClientSendDO对象", description="短信客户端发送")
@TableName("gtc_sms_client_send")
public class SmsClientSendDO implements Serializable  {
	...
	/**
	 * This property corresponds to db column <tt>client_apply_batch_id</tt>.<br>
     * 客户端申请批次号
     */
	private long clientApplyBatchId;
